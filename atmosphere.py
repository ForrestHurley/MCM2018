...
class atmosphere:
    def __init__(self,ray_count=10,ray_start=[60,90],ray_direction=[0,45],
        ...
        self.heatmap=heatmap(segments=region_segments,ray_count=self.number_rays)
        self.verbose = True
...
if __name__=="__main__":
    ...
    print(world.heatmap.binary_map())
    world.draw_from_log()
